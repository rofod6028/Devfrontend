...
function MainPage({ onSheetClick, onSparePartClick, facilityLists, inventoryData, userName, showToast, onDataRefresh, onSummaryClick, alerts, onSearch, searchResults, isSearching, onSearchResultClick }) {
  ...
  return (
    <div className="main-page">
      ...
      {/* ✨ 부품 추가 / 부품 삭제 — 작은 가로형 버튼, 세로로 배치 (수동 전용, AI 챗봇 미관여) */}
